 ...
 * @LastEditors: wangyun
 * @LastEditTime: 2019-11-12 17:50:53
 -->
  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-form inline class="demo-form-inline">
        ...
        <el-form-item>
          <el-input v-model="queryList.s_LIKE_account" placeholder="输入注册用户名查询" clearable />
        </el-form-item>
    ...
    >
      ...
      <el-table-column label="注册用户名" align="center" width="180">
        <template slot-scope="scope">{{ scope.row.account }}</template>
      </el-table-column>

      <el-table-column label="商品名称" align="center" min-width="160" show-overflow-tooltip>
...
<script>
import { regAccountOrderList, orderRemark } from '@/api/resourceRent/order'
...
export default {
  ...
  methods: {
    ...
    async fetchData() {
      ...
      try {
        let res = await regAccountOrderList(this.queryList)
    ...
    formVisible(style, item) {
      switch (style) {
        case 'detail':
          this.$router.push({
            path: '/resourceRent/regAccount/regAccount-detail',
