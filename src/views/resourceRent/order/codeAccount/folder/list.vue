 ...
 * @LastEditors: wangyun
 * @LastEditTime: 2019-11-12 17:49:49
 -->
  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-form inline class="demo-form-inline">
        ...
        <el-form-item>
          <el-input v-model="queryList.s_LIKE_account" placeholder="输入接收邀请码账号查询" clearable />
        </el-form-item>
    ...
    >
      ...
      <el-table-column type="expand">
        <template slot-scope="scope">
          <el-form label-position="left" class="demo-table-expand">
            ...
            <el-form-item label="商品名称">{{ scope.row.subject }}</el-form-item>
      ...
      <el-table-column label="接收邀请码账号" align="center" width="180" show-overflow-tooltip>
        <template slot-scope="scope">{{ scope.row.account }}</template>
      </el-table-column>

      <el-table-column label="商品名称" align="center" width="180" show-overflow-tooltip>
      ...
      <el-table-column label="商品金额" align="center" sortable="price" width="140">
...
<script>
import { codeAccountOrderList, orderRemark } from '@/api/resourceRent/order'
...
export default {
  ...
  methods: {
    ...
    async fetchData() {
      ...
      try {
        let res = await codeAccountOrderList(this.queryList)
    ...
    formVisible(style, item) {
      switch (style) {
        case 'detail':
          this.$router.push({
            path: '/resourceRent/codeAccount/codeAccount-detail',
