 ...
 * @LastEditTime: 2019-11-11 16:34:35
 -->
<template>
  <div>
    <!-- 已选择的DApp列表 -->
    <div class="app-container">
      <el-form style="text-align: center">
          <img
            ...
            :title="queryData.categoryName"
            width="150"
          />
        <el-form-item>
          <el-tag size="medium" effect="plain">{{queryData.categoryName}}</el-tag>
        </el-form-item>
      </el-form>
      ...
      <div class="filter-container" style="margin-top: 40px;">
        <el-form inline>
          <el-form-item>
            <el-tag>{{queryData.categoryName}}分类下的DApp列表</el-tag>
          </el-form-item>
          <el-form-item>
        ...
        <el-form inline class="demo-form-inline">
          <el-form-item>
            <el-badge :value="itemUnCheckedLength" :max="99" type="primary" class="item-badge">
              <el-tag type="danger">非{{queryData.categoryName}}分类下的DApp列表</el-tag>
            </el-badge>
          </el-form-item>
          <el-form-item>
  ...
  methods: {
    async fetchData() {
      ...
      try {
        ...
        let res = await getClassifyDapp({ categoryId })
    ...
    checkedHandler() {
      ...
      this.$confirm(
        `确定保存这${this.itemCheckedLength}个DApp到【${this.queryData.categoryName}分类】, 小老弟确定了么？ 是否继续？`,
        '提示',
        {
        ...
        .then(async () => {
          ...
          params = Object.assign(
            {},
            { categoryId: this.categoryId, dapps: checkArr }
          )
          console.log('params: ', params)
          try {
            let res = await saveClassifyDapp(params)
            if (res.code == 1000) {
              this.$notify.success({
                title: '成功',
                message: '保存成功'
